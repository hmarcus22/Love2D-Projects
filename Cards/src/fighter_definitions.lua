local fighters = {
    ...
    ninja = {
        ...
        shortName = "Ninja",
        color = { 0.2, 0.2, 0.2 },
    description = "Master of stealth and combos.",
    ...
    boxer = {
        ...
        shortName = "Boxer",
        color = { 0.9, 0.7, 0.3 },
        description = "Punches hard, builds up to haymaker.",
    ...
    wrestler = {
        ...
        shortName = "Wrestler",
        color = { 0.7, 0.5, 0.2 },
        description = "Throws and grapples for big combos.",
    ...
    karate_master = {
        ...
        shortName = "Karate",
        color = { 0.9, 0.9, 0.9 },
        description = "Focuses energy for devastating kicks.",
    ...
    street_brawler = {
        ...
        shortName = "Brawler",
        color = { 0.7, 0.3, 0.1 },
        description = "Unpredictable and tough.",
        starterCards = { "punch", "kick", "block" },
